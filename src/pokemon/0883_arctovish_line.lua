local arctovish = {
	...
	loc_vars = function(self, info_queue, card)
	  ...
	  return {vars = {abbr.suit1, abbr.suit2, abbr.Xmult_mod, abbr.retriggers, abbr.heartThreshold, abbr.handLevelAmount, colours = {G.C.SUITS[abbr.suit1 or "Clubs"], G.C.SUITS[abbr.suit2 or "Hearts"] }}}
	end,
	rarity = 2, --Uncommon
	cost = 6,
	stage = "Basic",
