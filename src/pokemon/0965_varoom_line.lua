local varoom = {
	name = "varoom",
	--pos = {x = 8, y = 64},
	config = {extra = {mult = 16, mult_mod = 2}, evo_rqmt = 36},
	...
	calculate = function(self, card, context)
		...
		return pokermon.scaling_evo(self, card, context, "j_stall_revavroom", card.ability.extra.mult, self.config.evo_rqmt)
	end,
}
