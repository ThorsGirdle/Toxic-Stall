  ...
  pages = {
    {
      ...
      tiles = {
        ...
        { list = { "j_stall_galarian_yamask", "runerigus" }, label = function() return localize { type = "name_text", set = "Joker", key = "j_stall_galarian_yamask" } end, config_key = "Galarian_Yamask" },
